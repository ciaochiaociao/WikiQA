...
df_pred = pandas.read_csv('experiments/model_v0.5_on_filtered/file4eval_filtered.tsv', sep='\t', header=0)
...
print('# questions answered: {0} ({0} / {1} = {2:.1%})'.format(num_answered, len(parsed), num_answered/len(parsed)))
